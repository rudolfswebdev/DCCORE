	...
	$output .= '<div class="home-subscribe-form clearfix">';
		$output .= '<div class="row">';
			...
			$output .= '<div class="col-md-5">';
				...
				if ( $id ) {
					$output .= do_shortcode( '[mc4wp_form id="'.$id.'"]' );
				}
				else {
...
function eventica_vc_subscribe_form() {
	...
	if ( function_exists('mc4wp_get_forms') ) {
		...
		$mailchimp_forms = array( '-- Select Form --' => '' );
		foreach( $forms as $form ) {
			$mailchimp_forms[ $form->name ] = $form->ID;
		}
	}
	vc_map( array(
	   ...
	   'params'				=> array(
								...
								array(
									'type'			=> 'dropdown',
									'heading'		=> __( 'Select Mailchimp Form', 'tokopress' ),
									'param_name'	=> 'id',
									'value'			=> $mailchimp_forms,
									'std'			=> ''
