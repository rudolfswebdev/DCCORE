...
add_shortcode( 'eventica_past_events', 'eventica_shortcode_past_events' );
function eventica_shortcode_past_events( $atts ) {
	...
	if ( !trim($title_text) )
		$title_text = __( 'Past Events', 'tokopress' );

	if ( !trim($link_text) )
		$link_text = __( 'All Past Events', 'tokopress' );
	...
	<div class="home-upcoming-events clearfix">
			...
			<?php if ( $title_hide != 'yes' ) : ?>
				<a class="upcoming-event-nav" href="<?php echo tribe_get_listview_past_link() ?>" <?php echo $link_style; ?>>
					<?php echo $link_text; ?> 
...
add_action( 'vc_before_init', 'eventica_vc_past_events' );
function eventica_vc_past_events() {

	vc_map( array(
	   'name'				=> __( 'Eventica - Past Events', 'tokopress' ),
	   'base'				=> 'eventica_past_events',
	   'class'				=> '',
	   'icon'				=> '',
	   'category'			=> 'Eventica',
	   'admin_enqueue_js' 	=> '',
	   ...
	   'params'				=> array(
								...
								array(
									...
									'description'	=> __( 'Default:', 'tokopress' ).' '.__( 'Past Events', 'tokopress' ),
								...
								array(
									...
									'description'	=> __( 'Default:', 'tokopress' ).' '.__( 'All Past Events', 'tokopress' ),
