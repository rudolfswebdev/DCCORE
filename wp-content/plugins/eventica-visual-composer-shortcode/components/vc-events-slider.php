				...
				$output .= '<div class="slide-event-detail" '.$detail_style.'>';
					...
					$output .= '<div class="slide-event-cta">';
						$output .= '<div class="slide-event-cta-date">';
							$output .= '<span class="mm">'.tribe_get_start_date( null, false, $month_format ).'</span>';
					...
					$output .= '<div class="slide-event-datetime">';
						$output .= '<div class="slide-event-datetime-details">';
							$output .= tokopress_tribe_event_time( false );
						$output .= '</div>';
					$output .= '</div>';
					$output .= tokopress_tribe_event_recurringinfo('<div class="slide-event-recurring"><div class="slide-event-recurring-details">', '</div></div>', false );
				$output .= '</div>';
				$output .= '</div>';
				$output .= '</div>';
				if ( $container == 'yes' ) {
