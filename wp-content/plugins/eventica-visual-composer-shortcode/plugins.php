...
include_once( 'components/vc-past-events.php' );
include_once( 'components/vc-featured-event.php' );
include_once( 'components/vc-event-venues.php' );
include_once( 'components/vc-event-organizers.php' );
include_once( 'components/vc-recent-posts.php' );
include_once( 'components/vc-posts-slider.php' );
