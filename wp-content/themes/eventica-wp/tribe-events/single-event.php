...
if ( post_password_required() ) {
	...
	tribe_get_template_part( 'custom/wrapper-start' );
	echo '<div id="tribe-events-content" class="tribe-events-single hentry">';
	the_content();
	echo '</div>';
	tribe_get_template_part( 'custom/wrapper-end' );
	return;
}

add_filter( 'post_class', 'tokopress_event_remove_hentry_class' );
function tokopress_event_remove_hentry_class( $classes ) {
...
<?php tribe_get_template_part( 'custom/fbcomments' ); ?>
