...
if ( of_get_option( 'tokopress_events_hide_single_related' ) )
	return;
...
if ( of_get_option( 'tokopress_events_include_past_related' ) ) {
...
$related_title = of_get_option( 'tokopress_events_custom_related_title' );
if ( !trim($related_title) ) {
	$related_title = __( 'RELATED EVENTS', 'tokopress' );
} 
