...
if ( function_exists('tokopress_events_list_the_date_headers') ) {
...
<div class="tribe-events-organizer">
		...
		<div class="events-single-right <?php echo esc_attr( $right_class ); ?>">
			...
			<div class="tribe_events">
				...
				<?php if( !has_post_thumbnail() && !get_the_content() ) : ?>
					<div class="tribe-events-event-image">
						<img src="<?php echo get_template_directory_uri(); ?>/img/thumb-organizer.png" alt="<?php the_title(); ?>">
					</div>
				<?php endif; ?>
	...
	<?php if ( function_exists( 'tribe_organizer_upcoming_events' ) ) : ?>
	...
	<?php else : ?>
		...
		<?php echo tribe_include_view_list( array( 'organizer'    => $organizer_id,
		                                           'eventDisplay' => 'list',
